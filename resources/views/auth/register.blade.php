        ...
        <div class="registration_page center_container">
            <div class="center_content">
                ...
                <div class="form-group icon_parent">
                        ...
                        <input id="email" class="form-control @error('email') is-invalid @enderror" placeholder="Enter your Email" name="email"

                        value="{{old('email')}}" required autocomplete="email" >
                        @error('name')
                        <span class="innvalid-feedback" role="alert">
                          <strong>{{$message}} </strong>
                        </span>
                        @enderror
                    ...
                    <div class="form-group icon_parent">
                        ...
                        <input id="confirm-password" type="password" placeholder="confirm password" class="form-control" name="password_confirmation"  required autocomplete="new-password">
                        <span class="icon_soon_bottom_right"><i class="fas fa-unlock"></i></span>
                    </div>
                ...
                <div class="footer">
                    <p>Copyright &copy; 2020 <a href="">Itemp</a>. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div><!--/ content wrapper -->
