       ...
       <nav class="nav">
         <div class="dropdown">
           <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
             <span class="logged-name">Amirul<span class="hidden-md-down"> Islam</span></span>
             <img src="{{asset('public/backend/img/')}}" class="wd-32 rounded-circle" alt="">
           </a>
